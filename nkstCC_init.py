...
class _DebugPrint:
    ...
    def err(self,err):
        if self.enable : 
            ...
            line = info.lineno
            print "LOG :: ",self.name,">>","Error at Line:",line,": ",err,"\n{"
            traceback.print_exc()
            print "\n}"
...
def ddList(dListName,dListitems,defaultItem,*infoText):
    class DropDownlistWindow(nukescripts.PythonPanel): 
        def __init__(self, name,items,default,*info): 
            ...
            nukescripts.PythonPanel.__init__(self,"%s"%name) 
            # Disclaimer text
            discText = """Nuke Studio Comp Cleaner v1.0
- by Fynn Laue  2016
Cleans up .nk files generated by Nuke Studio.
Read the "README.md" for more information and
hover over the controls below to read the tooltips.
